...
export default function sketch(p5: p5): void {
	...
	At every frame, the polygons are rotated, and are gradually morphed back and
	forth between another randomly generated set of polygons.
	*/

	// three random numbers to control how fast the polygons spin
	...
	// this object controls all of the morphing between two sets of polygons
	let morph: {
		t: number // internal counter
		T: number // maximum amount of frames for each morph cycle
	...
	const applyMorph = (): void => {
		/*
		This function first rotates the three polygons, and then calculates the morphing
		transition between another set of polygons.
		*/
	...
	p5.draw = () => {
		...
		// polygon 2 is inside of polygon 0, but hidden by polygon 1
